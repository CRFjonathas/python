...
class Aluno(Pessoa):
    ...
    def estudar(self):
        print(f"O aluno {self.nome} esta estdando {self.curso} na turma {self.turma}")
...
class Professor(Pessoa):
    ...
    def dar_aula(self):
        print(f"O professor {self.nome} iniciou a aula")
...
class Funcionario(Pessoa):
    ...
    def estudar(self):
        print(f"O funcionario {self.nome} se especializa para a area de {self.setor}")
